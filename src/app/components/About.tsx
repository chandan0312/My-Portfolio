      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-12 border border-gray-700 shadow-xl"
          >
            <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">
              Passionate <span className="text-orange-500">DevOps Engineer</span>
            </h3>
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              ...
              <p>
                With deep knowledge of <span className="text-orange-500">Docker and Kubernetes</span> concepts, I have successfully 
                implemented CI/CD pipelines using tools like Jenkins, GitLab, GitHub Actions, Azure Release Pipelines, and more. 
                I have extensive hands-on experience with both <span className="text-orange-500">Azure and AWS</span> cloud platforms.
              </p>
              <p>
                Currently working at <span className="text-orange-500 font-semibold">Tata Consultancy Services (TCS)</span> as a 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
              {expertise.map((item, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 bg-gray-800/50 rounded-lg p-4 border border-gray-700 hover:border-orange-500/50 transition-all"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {highlights.map((item, index) => (
              <motion.div
                ...
                className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700 hover:border-orange-500/50 transition-all overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div className={`inline-flex p-3 bg-gradient-to-br ${item.color} rounded-full mb-4`}>

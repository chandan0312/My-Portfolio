      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="p-2 bg-gray-800 rounded-lg hover:bg-gradient-to-br hover:from-orange-500 hover:to-red-600 transition-all hover:scale-110"
                >
            ...
            {/* Contact Info */}
            <div>
              <h4 className="font-bold mb-4 text-lg text-white">Contact Info</h4>
              <ul className="space-y-2 text-gray-400">
                <li>
                  <a href="mailto:chndnkumar666@gmail.com" className="hover:text-orange-500 transition-colors">
                    chndnkumar666@gmail.com
                  </a>
                </li>
                <li>
                  <a href="tel:+919934457318" className="hover:text-orange-500 transition-colors">
                    +91-9934457318
                  </a>
                </li>
                <li>India</li>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <p className="text-gray-400 text-sm">
                Built with <span className="text-orange-500">React</span>, <span className="text-orange-500">Tailwind CSS</span>, and <span className="text-orange-500">Motion</span>
              </p>
            </div>
          </div>
        </div>
